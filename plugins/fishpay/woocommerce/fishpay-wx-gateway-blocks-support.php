...
final class Fishpay_Wx_Gateway_Blocks_Support extends AbstractPaymentMethodType {

    private $gateway;
    protected $name = 'fishpay_wx_gateway'; // payment gateway id
    ...
    public function get_payment_method_script_handles() {
        wp_register_script(
            'wc-fishpay-wx-blocks-integration',
